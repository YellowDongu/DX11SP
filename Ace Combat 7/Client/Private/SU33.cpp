...
SU33::SU33(ID3D11Device* dxDevice, ID3D11DeviceContext* dxDeviceContext) : GameObject(dxDevice, dxDeviceContext), model(nullptr), gearModel(nullptr), flightModule(nullptr), boneHandler(nullptr), fcs(nullptr), autoPilot(nullptr), collider(nullptr)
{
}

SU33::SU33(const SU33& other) : GameObject(other)
{
...
SU33* SU33::Create(ID3D11Device* dxDevice, ID3D11DeviceContext* dxDeviceContext)
{
    SU33* newInstance = new SU33(dxDevice, dxDeviceContext);
    newInstance->metaData.allyInfo = 2;
    newInstance->metaData.gameObejctName = L"Test";
    newInstance->metaData.aircraftInfomation = SU33MetaData();
...
SU33* SU33::Create(ID3D11Device* dxDevice, ID3D11DeviceContext* dxDeviceContext, ObjectInfomation& infomation)
{
    SU33* newInstance = new SU33(dxDevice, dxDeviceContext);
...
Engine::GameObject* SU33::Clone(void)
{
    return new SU33(*this);
}
