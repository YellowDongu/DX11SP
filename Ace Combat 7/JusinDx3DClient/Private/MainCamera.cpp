...
{	
	...
	camera = Engine::Camera::Create(dxDevice, dxDeviceContext, transformComponent, 45.0f, static_cast<FLOAT>(windowSizeX) / static_cast<FLOAT>(windowSizeY), 0.1f, 100000.0f);
	if (!camera)
		return E_FAIL;
